<section class="content">
    <div class="container-fluid">
        <h5 style="margin-top:15px; margin-bottom:15px">Informasi Pekerjaan</h5>
        <hr>
        <div class="row" id="form-pekerjaan-wira">
            <div class="col-md-6">
                <!-- Start Informasi Pekerjaan Wira -->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <div class="input-group">
                                        ...
                                        <div class="col-md-1" style="display:flex; justify-content:center; align-items:center; font-weight:bold; margin:2px">
                                            <center>
                                                Thn
                                            </center>
                                        </div>
                ...
                <br>
                <!-- END Informasi Pekerjaan Wira -->
            </div>
            <div class="col-md-6">
                <!-- Start Informasi Pekerjaan Pasangan Wira -->
                <div class="flex-square">
                    <div class="flex-square-title">
                        <center>
                ...
                <!-- END Informasi Pekerjaan Pasangan Wira -->
            </div>
        </div>
        <!-- /.card-body -->
    </div>
